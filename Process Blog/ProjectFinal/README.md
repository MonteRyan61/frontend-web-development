...
## Milestone 4
Looking back on this project it came out exceeding expectations. We were able to achieve our stretch goals along with make some new ones and achieve those also! As shown in this blog I overcame a lot of challenges. Without these challenges I would not have learned nearly as much as I did about React. Through each of the problems I ran into I had to do more research about React to resolve and thus learned alot more about the framework. Learning Reacts state was the most confusing but coolest part along with the inheritance of each class component. I truly think that I have now added React to my toolbelt. I will be creating a fishing web based application in React for my capstone so this got me some great exposure before that much bigger project.