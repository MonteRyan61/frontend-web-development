...
On the main landing page I experimented with the border-radius attribute on the buttons. I found this very cool how unique you could make the once rectangles look. With this odd shape I ran into the problem that when the screen was to small the text would sometimes be outside of the shape. I solved this by doing some research and finding out that you can create responsive text through font-size:2vw;. With this when I add my project names if they are longer they will stay contained in the shape when the screen is smaller. The font gets small on small windows so I may take this feature out in the future but want to leave included for now.
